    ...
    <div class="">
        ...
        <footer class="fixed bottom-0 left-0 w-full  bg-[#1A1A1D] z-50">
            <div class="flex justify-between items-center py-2 relative">
                ...
                <a href="/about" class="flex flex-col items-center flex-1 text-gray-400 hover:text-indigo-600">
                    <svg class="w-6 h-6 mb-1" fill="currentColor" viewBox="0 0 24 24">
                        <!-- SVG for Search -->
                        <path fill="white" d="M13 1h-2v2H9v2H7v2H5v2H3v2H1v2h2v2h2v2h2v2h2v2h2v2h2v-2h2v-2h2v-2h2v-2h2v-2h2v-2h-2V9h-2V7h-2V5h-2V3h-2zm0 2v2h2v2h2v2h2v2h2v2h-2v2h-2v2h-2v2h-2v2h-2v-2H9v-2H7v-2H5v-2H3v-2h2V9h2V7h2V5h2V3zm0 4h-2v6h2zm0 8h-2v2h2z"/>
                    </svg>
                ...
                <a href="/profile" wire:navigate class="flex flex-col items-center flex-1 text-gray-400 hover:text-indigo-600">
                    <svg class="w-6 h-6 mb-1" fill="currentColor" viewBox="0 0 24 24">
                        <!-- SVG for Profile -->
                        <path fill="white" d="M15 2H9v2H7v6h2V4h6zm0 8H9v2h6zm0-6h2v6h-2zM4 16h2v-2h12v2H6v4h12v-4h2v6H4z"/></svg>
